...
This package consist on one node. The aim of the node is to draw a simplified "Batman logo". The type of the published topic is `geometry_msgs/twist`. Builds in `ROS 2 Humble`.
